...
class FakeReservationService implements ReservationBase {
  ...
  @override
  Future<List<AppReservation>> getReservationsByPropertyID(
    ...
    return Future.delayed(
        ...
        () => [
              AppReservation(
                  ...
                  bildirimSuresi: 15,
                  status: 1,
                  createdAt: "2022-02-18T08:51:59.000000Z",
                  updatedAt: "2022-02-18T09:31:00.000000Z",
                  profilePhotoUrl:
